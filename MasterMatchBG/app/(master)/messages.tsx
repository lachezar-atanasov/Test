...
const MOCK_CONVERSATIONS = [
  {
    ...
    jobTitle: 'Paint kitchen walls',
    lastMessage: 'When can you come by to see the kitchen?',
    timestamp: '2:30 PM',
    unread: 1,
  },
  {
    id: '2',
    clientName: 'Petar Georgiev',
...
export default function MasterMessagesScreen() {
  return (
        ...
        {MOCK_CONVERSATIONS.length === 0 ? (
          <View className="items-center justify-center py-20">
            ...
            <Text className="text-gray-500 text-center mt-2 px-10">
              When clients accept your offers, you can chat with them here
            </Text>
          </View>
        ) : (
